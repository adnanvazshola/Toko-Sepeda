                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <label><strong>Telp:</strong> {{ $row->pelanggan_telephone }}</label><br>
                                                <label><strong>Alamat:</strong> 
                                                    {{ $row->pelanggan_alamat }} 
                                                    {{ $row->pelanggan->kecamatan->nama }} - 
                                                    {{ $row->pelanggan->kecamatan->kota->nama }}, 
                                                    {{ $row->pelanggan->kecamatan->kota->provinsi->nama }}</label>
                                            </td>
