		...
		<div class="banner_inner d-flex align-items-center">
			<div class="container">
				<div class="banner_content text-center">
					...
					<div class="page_link">
            <a href="{{ url('/') }}">Home</a>
            <a href="{{ route('pelanggan.orders') }}">Order {{ $order->invoice }}</a>
					</div>
				</div>
			</div>
		</div>
                ...
                <div class="card-header">
                    <h4 class="card-title">Data Pelanggan</h4>
                      ...
                      <tr>
                          <td>Alamat</td>
                          <td>:</td>
                          <th>{{ $order->pelanggan_alamat }}, {{ $order->kecamatan->nama }} {{ $order->kecamatan->kota->nama }}, {{ $order->kecamatan->kota->provinsi->nama }}</th>
                      </tr>
                  </table>
								</div>
							</div>
